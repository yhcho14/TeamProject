...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    {
        if(PhotonNetwork.CurrentRoom.PlayerCount == 2 && PhotonNetwork.LocalPlayer == PhotonNetwork.MasterClient)
            PhotonNetwork.LoadLevel("MultiStage1-1");
    }
